...
export interface IOrderBookV2Interface extends utils.Interface {
  functions: {
...
export interface IOrderBookV2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IOrderBookV2Interface;
  ...
  functions: {
    ...
    clear(
      ...
      aliceSignedContext: SignedContextV1Struct[],
      bobSignedContext: SignedContextV1Struct[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
