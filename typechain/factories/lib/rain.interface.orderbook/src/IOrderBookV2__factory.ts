...
import type {
  IOrderBookV2,
  IOrderBookV2Interface,
} from "../../../../lib/rain.interface.orderbook/src/IOrderBookV2";
...
export class IOrderBookV2__factory {
  static readonly abi = _abi;
  static createInterface(): IOrderBookV2Interface {
    return new utils.Interface(_abi) as IOrderBookV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IOrderBookV2 {
    return new Contract(address, _abi, signerOrProvider) as IOrderBookV2;
  }
}
