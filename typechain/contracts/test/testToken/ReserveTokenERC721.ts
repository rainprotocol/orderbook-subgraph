...
export interface ReserveTokenERC721Interface extends utils.Interface {
  functions: {
...
export interface ReserveTokenERC721 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReserveTokenERC721Interface;
