...
export interface ReserveTokenERC1155Interface extends utils.Interface {
  functions: {
...
export interface ReserveTokenERC1155 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReserveTokenERC1155Interface;
  ...
  callStatic: {
    ...
    mintNewToken(overrides?: CallOverrides): Promise<void>;
