...
export interface RedeemableERC20ClaimEscrowWrapperInterface
  extends utils.Interface {
  functions: {
    "deposit(address,address,uint256)": FunctionFragment;
    "depositPending(address,address,uint256)": FunctionFragment;
    "getDeposits(address,address,address,uint256)": FunctionFragment;
    "getPendingDeposits(address,address,address)": FunctionFragment;
    "getTotalDeposits(address,address,uint256)": FunctionFragment;
    "getWithdrawals(address,address,uint256,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getPendingDeposits",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<string>
  ...
  encodeFunctionData(
    functionFragment: "getWithdrawals",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>,
...
export interface RedeemableERC20ClaimEscrowWrapper extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RedeemableERC20ClaimEscrowWrapperInterface;
