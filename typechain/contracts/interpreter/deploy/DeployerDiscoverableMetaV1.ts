...
export interface DeployerDiscoverableMetaV1Interface extends utils.Interface {
  functions: {};
...
export interface DeployerDiscoverableMetaV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DeployerDiscoverableMetaV1Interface;
