...
describe("OrderClearStateChange entity", () => {
  ...
  it("should query OrderClearStateChange after clearing orders", async function () {
    ...
    // The ID of OrderClearStateChange is auto-generated by the SG, so get the
    // OrderClearStateChange through the OrderClear to test the OrderClearStateChange
